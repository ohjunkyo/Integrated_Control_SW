...
void setup() {
  ...
  for (int i = 0; i < NUM_SENSORS; i++) {
    ...
    dht_sensors[i]->begin();
    delay(100); 
    // 다음 센서 초기화 전 안정화를 위한 짧은 지연
  }
}

/**
 * @brief 메인 루프.
 * 2초마다 모든 센서의 데이터를 읽어 시리얼 포트로 전송합니다.
 */
void loop() {
  // 2초 동안 대기합니다.
  // (DHT22 센서의 최소 샘플링 주기는 2초입니다.)
  delay(2000); 

...
const std::string RotateAngle2 = "135.0";
const std::string TiltAngle2 = "25.7";

const std::string RotateAngle3 = "135.0";
const std::string TiltAngle3 = "30.6";
...
// --- NOTE ---
const std::string NOTE = "Intensity adjusting";
